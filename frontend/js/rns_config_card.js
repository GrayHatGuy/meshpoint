 ...
 * to monitor Reticulum traffic via the USB RNode source on the
 * rnodeusb branch — the SX1302 concentrator is MT-only here).
 *
...
class RnsConfigCard {
    ...
    render(config) {
        ...
        // rnodeusb branch: SX1302 multi-protocol capture is removed,
        // so RNS only ever flows through the USB RNode.
        const multiProto = false;
